...
public class Player2 : MonoBehaviour
{
    ...
    void getDamaged ()
    {
        ...
        if (otherObject.GetComponent<Player1>().sword == true)
        {
            health -= 20;
            stamina -= 15;
        }

        else if (otherObject.GetComponent<Player1>().chopper == true)
        {
            health -= 25;
            stamina -= 20;
        }
    ...
    void Update ()
    {
        ...
        healthBar = GameObject.Find("HealthBar2");
        staminaBar = GameObject.Find("StaminaBar2");
        gameOver = GameObject.Find("GameOver");
        otherDefence = otherObject.GetComponent<Player1>().defending;
        otherRight = otherObject.GetComponent<Player1>().right;
        otherUp = otherObject.GetComponent<Player1>().up;
        ...
        if (sword == true)
        {
            if (canMove == true & Input.GetKeyDown(KeyCode.UpArrow))
            {
                up = true;
            }
            
            if (canMove == true & Input.GetKeyDown(KeyCode.DownArrow))
            {
                up = false;
            }
            ...
            {
                if (doing == false & Input.GetKeyDown(KeyCode.Keypad1))
                {
                    stamina -= 25;
                    canMove = false;
                    moving = true;
                ...
                else if (doing == false & Input.GetKeyDown(KeyCode.Keypad2))
                {
                    stamina -= 10;
                    canMove = false;
                    moving = true;
                ...
                else if (doing == false & Input.GetKeyDown(KeyCode.Keypad3))
                {
                    stamina -= 15;
                    canMove = false;
                    moving = true;
                ...
                else if (doing == false & Input.GetKey(KeyCode.RightArrow) & !Input.GetKey(KeyCode.LeftArrow) & !Input.GetKeyDown(KeyCode.Keypad5))
                {
                    moving = true;
                    right = true;
                ...
                else if (doing == false & Input.GetKey(KeyCode.LeftArrow) & !Input.GetKey(KeyCode.RightArrow) & !Input.GetKeyDown(KeyCode.Keypad5))
                {
                    moving = true;
                    right = false;
                    speed = speed + Time.deltaTime;
        ...
        else if (chopper == true)
        {
            ...
            if (doing == false & Input.GetKeyDown(KeyCode.Keypad5))
            {
                stamina -= 25;
                shield = true;
            }

            if (doing == true & Input.GetKeyDown(KeyCode.Keypad5))
            {
                canMove = true;
                defending = false;
                shield = false;
            ...
            if (canMove == true & up == true & right == true)
            {
                ...
                else if (doing == false & Input.GetKey(KeyCode.RightArrow) & !Input.GetKey(KeyCode.LeftArrow))
                {
                    moving = true;
                    right = true;
                    speed = speed + Time.deltaTime;
                ...
                else if (doing == false & Input.GetKey(KeyCode.LeftArrow) & !Input.GetKey(KeyCode.RightArrow))
                {
                    moving = true;
                    right = false;
                    speed = speed + Time.deltaTime;
